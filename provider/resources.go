...
import (
	...
	"github.com/peter-soderkvist/pulumi-upcloud/provider/pkg/version"
)
...
const (
	...
	mainPkg = "upcloud"
	// modules:
	mainMod = "index" // the upcloud module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-upcloud/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-upcloud/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "upcloud", upcloud.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-upcloud/provider".New
		...
		Keywords:   []string{"peter-soderkvist", "upcloud", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/peter-soderkvist/pulumi-upcloud/sdk/",
